...
type Skill struct {
	...
	HasPendingRevision       bool       `json:"has_pending_revision" gorm:"-"`
	PendingRevisionID        *uint      `json:"pending_revision_id,omitempty" gorm:"-"`
	PendingRevisionAI        string     `json:"pending_revision_ai,omitempty" gorm:"-"`
	PendingRevisionHuman     string     `json:"pending_revision_human,omitempty" gorm:"-"`
	PendingRevisionUpdatedAt *time.Time `json:"pending_revision_updated_at,omitempty" gorm:"-"`
